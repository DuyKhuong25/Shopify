...
public class User {
    ...
    public String toString() {
        return "User {id=" + id + ", email=" + email + ", firstName=" + firstName + ", lastName=" + lastName
                + ", roles=" + roles + ", status=" + enabled +", photos=" + photos + "}";
    }

    @Transient
    public String getPhotoPath(){
        if(id == null || photos == null) return "/images/user-default-thumb.png";
        return Constants.S3_URI + "user-photo/" + this.id + "/" + this.photos;
    }
}
